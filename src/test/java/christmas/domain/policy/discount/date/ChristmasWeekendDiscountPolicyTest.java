...
import static christmas.domain.policy.discount.date.ChristmasWeekendDiscountPolicy.NAME;
...
class ChristmasWeekendDiscountPolicyTest {
    ...
    public void 크리스마스_주말이면_할인_적용으로_메인메뉴당_2023원_할인_금액_반환(int weekend) throws Exception {
        ...
        // 메인메뉴 2개
        Discount actualResult = new Discount(NAME, DISCOUNT_PER_MAIN_MENU_COUNT * 2);
    ...
    public void 크리스마스_평일이면_할인_적용안되므로_메인메뉴당_0원_반환(int weekDay) throws Exception {
        ...
        long amount = (long) Reflector.getValue(result, 1);
        // then
